  ...
  function render() {
    ...
    O.icerik(`
      ...
      ${O.statGrid([
        ...
        { label: 'Toplantı Odası', deger: odalar.length, alt: odalar.reduce((t, o) => t + (o.kapasite || 0), 0) + ' kişi kapasite', renk: '#8B5CF6' },
        { label: 'Rezervasyon', deger: gunlukRez().length, alt: O.tarih(secilenTarih), renk: '#4F6EF7' },
      ])}
      ${O.sekmeler('zyr-tabs', [
      ...
      <div class="panel" style="overflow-x:auto">
        <table class="personel-tablo idari-tablo">
          ...
          <tbody>${liste.length ? liste.map(z => `
            <tr ${z.icerde ? 'style="background:#FFFBEB"' : ''}>
              ...
              <td>${z.cikis_zamani ? O.saatli(z.cikis_zamani) : O.rozet('İçeride', '#F59E0B')}</td>
